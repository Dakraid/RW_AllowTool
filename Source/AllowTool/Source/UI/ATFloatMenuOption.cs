...
namespace AllowTool
{
    ...
    public class ATFloatMenuOption : FloatMenuOption
    {
        ...
        public ATFloatMenuOption(string label, Action action, MenuOptionPriority priority = MenuOptionPriority.Default, Action mouseoverGuiAction = null,
            Thing revalidateClickTarget = null, float extraPartWidth = 0, Func<Rect, bool> extraPartOnGUI = null, WorldObject revalidateWorldClickTarget = null,
        ...
        public override bool DoGUI(Rect rect, bool colonistOrdering, FloatMenu floatMenu)
        {
            ...
            if (showWatermark)
            {
                ...
                var hovering = !Disabled && Mouse.IsOver(hoverRect);
                ...
                if (tooltipText != null) TooltipHandler.TipRegion(hoverRect, tooltipText);
            }
