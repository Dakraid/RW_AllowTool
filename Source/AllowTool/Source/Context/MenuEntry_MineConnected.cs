...
namespace AllowTool.Context
{
    public class MenuEntry_MineConnected : BaseContextMenuEntry
    {
        ...
        public override ActivationResult Activate(Designator designator, Map map)
        {
            ...
            if (!anyMineDesignations) return ActivationResult.Failure(BaseMessageKey);
        ...
        private void MineDesignateSelectedOres(Map map)
        {
            ...
            foreach (var thing in toDesignate) thing.Position.ToggleDesignation(DesignationDefOf.Mine, true);
        }
        ...
        private int FloodExpandDesignationType(DesignationDef designationDef, Map map, InitialCandidateFilter initialFilter, ExpansionCandidateFilter expansionFilter)
        {
            ...
            if (cyclesLimit == 0) AllowToolController.Logger.Error("Ran out of cycles while expanding designations: " + Environment.StackTrace);
            return hitCount;
        }
