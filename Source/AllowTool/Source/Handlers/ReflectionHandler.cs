...
namespace AllowTool
{
    ...
    public class ReflectionHandler
    {
        ...
        internal void PrepareReflection()
        {
            ...
            if (gizmoGridType != null) GizmoGridGizmoListField = gizmoGridType.GetField("gizmoList", HugsLibUtility.AllBindingFlags);
            ...
            if (GizmoGridGizmoListField == null || GizmoGridGizmoListField.FieldType != typeof(List<Gizmo>)
                                                ...
                                                || DesignatorGetRightClickFloatMenuOptionsMethod == null ||
                                                DesignatorGetRightClickFloatMenuOptionsMethod.ReturnType != typeof(IEnumerable<FloatMenuOption>)
                                                ...
                                                DesignationCategoryDefResolveDesignatorsMethod.GetParameters().Length != 0
