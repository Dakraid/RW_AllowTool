...
namespace AllowTool
{
    ...
    public class ModSettingsHandler
    {
        ...
        internal void PrepareSettingsHandles(ModSettingsPack pack)
        {
            ...
            ExtendedContextActionSetting = pack.GetHandle("extendedContextActionKey", "setting_extendedContextHotkey_label".Translate(),
                "setting_extendedContextHotkey_desc".Translate(), true);
            ReverseDesignatorPickSetting = pack.GetHandle("reverseDesignatorPick", "setting_reverseDesignatorPick_label".Translate(),
                "setting_reverseDesignatorPick_desc".Translate(), true);
            ...
            SelectionLimitSetting = pack.GetHandle("selectionLimit", "setting_selectionLimit_label".Translate(), "setting_selectionLimit_desc".Translate(), 200,
                Validators.IntRangeValidator(50, 100000));
            ...
            foreach (var handle in DesignatorContextMenuController.RegisterMenuEntryHandles(pack)) handle.VisibilityPredicate = menuEntryHandleVisibility;
            // reverse designators
        ...
        {
            return handleDict.TryGetValue(handleName, out var handle) && handle.Value;
        }
