...
namespace AllowTool
{
    public class Designator_FinishOff : Designator_SelectableThings
    {
        ...
        public override string Desc
        {
            get
            {
                if (AllowToolController.Instance.Handles.FinishOffSkillRequirement) return $"{base.Desc}\n\n{"Finish_off_skillRequired".Translate(MeleeSkillLevelRequired)}";
                return base.Desc;
            }
        }
        ...
        public static AcceptanceReport PawnMeetsSkillRequirement(Pawn pawn, Pawn targetPawn)
        {
            ...
            if (!AllowToolUtility.PawnCapableOfViolence(pawn)) return new AcceptanceReport("IsIncapableOfViolenceShort".Translate());
            ...
            if (!targetIsAnimal && !skillPass) return new AcceptanceReport("Finish_off_pawnSkillRequired".Translate(MeleeSkillLevelRequired));
