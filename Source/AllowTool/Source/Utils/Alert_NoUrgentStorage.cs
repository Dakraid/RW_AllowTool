...
namespace AllowTool
{
    ...
    public class Alert_NoUrgentStorage : Alert
    {
        ...
        protected override Color BGColor => new Color(1f, 0.9215686f, 0.01568628f, .35f);
        ...
        public override AlertReport GetReport()
        {
            ...
            {
                RecacheIfNeeded();
                if (cachedHaulablesWithoutDestination.Count > 0) return AlertReport.CulpritsAre(cachedHaulablesWithoutDestination);
            }
